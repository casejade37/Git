...
public static void reverse(DoublyLinkedList<Integer> intList) {
	...
	public static void reverse(DoublyLinkedList<Integer> intList) {
		DoublyLinkedList<Integer> first = intList.getHeader().getNext();
		reverseRecurse(intList, first);
	}

	public static void reverseRecurse(DoublyLinkedList<Integer> intList, DoublyLinkedNode<Integer> sentinel) {
