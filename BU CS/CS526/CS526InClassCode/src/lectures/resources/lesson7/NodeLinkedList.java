...
public class NodeLinkedList<E> {
     ...
     *
     * @param node the Node before which the insertion takes place
     * @param e the new element
     * @return the Node representing the location of the new element
     ...
     *
     * @param node the Node after which the insertion takes place
     * @param e the new element
     * @return the Node representing the location of the new element
     * @throws IllegalArgumentException if p is not a valid position for this list
     */
     ...
     *
     * @param node the Node of the element to be replaced
     * @param e the new element
